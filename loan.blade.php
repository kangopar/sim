...
<html>
	...
	<body>
		<form name="entry_form" id="entry_form" action="{{URL::current()}}" method="post">
			<table width="40%" align="center">
				...
				<tr class="odd">
					...
					<td width="50%">{{Form::text('loan_amount', $loan_amount, array('size'=>'30'))}}
					</td>
				</tr>
				<tr class="even">
					<td>Annual interest rate :</td>
					<td>{{Form::text('anu_int_rt', $anu_int_rt, array('size'=>'30'))}}
					</td>
				</tr>
				<tr class="odd">
					<td>Loan period in years :</td>
					<td>{{Form::text('ln_prd_years', $ln_prd_years, array('size'=>'30'))}}
					</td>
				</tr>
				<tr class="even">
					<td>Number of payments per year :</td>
					<td>{{Form::text('pmnt_p_year', $pmnt_p_year, array('size'=>'30'))}}
				</td>
				</tr>
				<tr class="odd">
					<td>Start date of loan :</td>
					<td>{{Form::text('start_date', $start_date, array('size'=>'30'))}}
					</td>
				</tr>
				<tr class="even">
					<td>Optional extra payments :</td>
					<td>{{Form::text('extra_pmnt', $extra_pmnt, array('size'=>'30'))}}
					</td>
				</tr>
				<tr class="odd">
